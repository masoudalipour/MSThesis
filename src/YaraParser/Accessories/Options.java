...
public class Options implements Serializable {
    ...
    public static void showHelp() {
        String output = "© Yara YaraParser.Parser \n" + "\u00a9 Copyright 2014, Yahoo! Inc.\n" + "\u00a9 Licensed " +
                "under the terms of the Apache License 2.0. See LICENSE file at the project root for " + "terms." +
                "http://www.apache.org/licenses/LICENSE-2.0\n" + "\n" + "Usage:\n" + "* Train a parser:\n" + "\tjava " +
                "-jar YaraParser.jar train -train-file [train-file] -dev [dev-file] -model [model-file] -punc " +
                "[punc-file]\n" + "\t** The model for each iteration is with the pattern [model-file]_iter[iter#]; e" +
                ".g. mode_iter2\n" + "\t** [punc-file]: File contains list of pos tags for punctuations in the " +
                "treebank, each in one " + "line\n" + "\t** Other options\n" + "\t \t -cluster [cluster-file] Brown " +
                "cluster file: at most 4096 clusters are supported by the parser " + "(default: empty)\n\t\t\t the " +
                "format should be the same as https://github" + ".com/percyliang/brown-cluster/blob/master/output.txt" +
